                                    ...
                                    <div class="ec-vendor-upload-detail">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <select name="subcategory_id[]" id="subcategory_id" class="form-select" multiple>
    @foreach($subcategories as $subcategory)
        <option value="{{ $subcategory->id }}"
            {{ (collect(old('subcategory_id', $product->subcategory_id ?? []))->contains($subcategory->id)) ? 'selected' : '' }}>
            {{ $subcategory->name }}
        </option>
    @endforeach
</select>
                              ...
                                        </div>
                                            ...
                                            <div class="col-12 mt-3">
                                                <button type="submit" class="btn btn-primary">Copy Product</button>
                                            </div>

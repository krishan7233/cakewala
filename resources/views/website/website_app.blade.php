...
<head>
    <meta charset="utf-8"/>
        ...
        <link rel="dns-prefetch" href="http://d3s16h6oq3j5fb.cloudfront.net/">
         <link rel="icon" href="{{URL('/')}}wp-content/uploads/2020/10/Favicon.png" sizes="32x32" />
        ...
        <meta property="og:site_name" content="Cake Wala">
            ...
            <div class="col l3 s12">
                <ul style="border-right: 2px solid #dfdcdc;width:70%">
                 <li style="color: #000000;font-size:16px;font-weight:600;padding-bottom: 10px;">Our Company</li>
                    ...
                    <li><a class="footerTextColor" href="#"><strong>Email:</strong> info@Cake Wala.in</a></li>
            ...
            <div class="col l3 s12">
                <ul>
                 <li style="color: #000000;font-size:16px;font-weight:600;padding-bottom: 10px;">Helpful Links</li>
                  ...
                  <li><a class="footerTextColor" href="https://razorpay.me/@Cake Wala">Pay Online</a></li>
...
<div style="background: #F5F5F5 0% 0% no-repeat padding-box;float:left;width:100%">
                   ...
                   <div class="row">
                    <div class="col m2 contactWithUS" style="margin-top: 20px;">
                       ...
                       <div class="col m2 imageWidth" style="margin-top: 20px;width: 6%;">
                           <a  target="_BLANK" rel="nofollow" href="https://www.facebook.com/Cake Walaofficial/">
                               <div>
                        ...
                        <div class="col m2 imageWidth" style="  margin-left: -25px!important;width: 6%;important">
                          <a   target="_BLANK" rel="nofollow" href="https://www.instagram.com/Cake Walaofficial/">
                              <div class="">
                       ...
                       <div class="col m2 imageWidth" style=" margin-left: -25px!important;width: 6%;important">
                           <a target="_BLANK" rel="nofollow" href="https://www.youtube.com/@officialCake Wala">
                               <div>
                       ...
                       <div class="col m2 imageWidth" style=" margin-left: -25px!important;width: 6%;!important">
                           <a  target="_BLANK" rel="nofollow" href="https://twitter.com/Cake Wala">
                               <div>
                       ...
                       <div class="col m2 imageWidth" style="margin-left: -25px;width: 6%;">
                          <a  target="_BLANK" rel="noopener"  href="https://www.youtube.com/@officialCake Wala">
   ...
   <div class="col m6 l6" style="padding-right: 0px;">
        ...
        <div style="color: #333333;text-align:center;background: #F5F5F5 0% 0% no-repeat padding-box;padding-top:25px;padding-bottom:25px">Copyright © 2025 Cake Wala. All rights reserved.</div>

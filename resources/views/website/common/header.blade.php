...
img.responsive-img.imageRadius {
    border-radius: 15px;
}
.profile-dropdown-wishlist {
    top: 65px !important;
                        ...
                        <div class="col l6" style="padding-right: 0;position: relative;">
                            <ul class=" hide-on-med-and-down nav-options">
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('product.cart') }}" class="adbHeaderLink clearfix">
                                        <div class="left" style="position: relative;">
                                         <span class=" adbHeaderLink dropdown-trigger" data-hover="true" data-belowOrigin="false" data-target="dropdownwishlist" data-constrainWidth="false">
                                             <img  alt="cart-item" id="setImageWithcartDesktop" class="hoverEffectOnHeart"  src="{{asset('assets/website/img/cart.png')}}" style="margin-top: 3px;margin-right: 2px;position: absolute;right: -9px;top: 5px;" >
                                             
                                        </span>
                                        </div>
                                        <div class="left" style="background: #ED217C;border-radius: 50%;padding: 3px 8px;">
                                            <div style="color:white; line-height: 16px;"><span id="cart_itme">{{ $cartCount }}</span>
                                            </div>
                                        </div>
                             ...
                             <li class="hdr-crt-qty right" style="margin-left: 20px;">
                                    <!--<a href="{{route('wishlist.index')}}" class="adbHeaderLink clearfix">-->
                                    <!--    <div class="left" style="position: relative;">-->
                                    <!--     <span class=" adbHeaderLink dropdown-trigger" data-hover="true" data-belowOrigin="false" data-target="dropdownwishlist" data-constrainWidth="false">-->
                                    <!--         <img  alt="without-heart" id="setImageWithHeartDesktop" class="hoverEffectOnHeart"  src="{{asset('assets/website/img/without-heart.webp')}}" style="margin-top: 3px;margin-right: 2px;position: absolute;right: -9px;top: 5px;" >-->
                                             
                                    <!--    </span>-->
                                    <!--    </div>-->
                                    <!--    <div class="left" style="background: #ED217C;border-radius: 50%;padding: 3px 8px;">-->
                                    <!--        <div style="color:white; line-height: 16px;"><span id="wishlist_item">{{ $wishlistCount }}</span>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--    <input type="hidden" value="Cart Item" />-->
                                    <!--    </a>-->
                                </li>
                             <ul id="dropdownwishlist" class='dropdown-content profile-dropdown-wishlist' style="display:none!important; padding: 0px 20px 8px 10px;margin-top:-30px;width:40px!important;border-radius:6px!important">
                                                                    ...
                                                                    <span>
                                                                        <span class="adbHeaderLink dropdown-trigger" data-hover="true" data-belowOrigin="false" data-target="dropdownprofile" data-constrainWidth="false">
                                                                            <div class="left profileImageHeader">
                                                                                <img alt="user-icon-grey" class="profileImage" src="{{asset('assets/website/img/user-icon-grey.webp')}}" style="margin-top: 10px;width: 23px;"   onmouseover="hoverImage(this)" onmouseout="unhoverImage(this)">
                                                                            </div>
                                                                            <input type="hidden" value="My Profile" />
                                                                        </span>
                                                                        <ul id="dropdownprofile" class='dropdown-content profile-dropdown profileLeft' style="padding: 0px 20px 8px 10px;margin-top:-35px;border-radius:5px!important;">
                                                                            <div style="margin-top: 10px;text-align: left;border-bottom: 1px solid #f0f0f0;padding-bottom: 10px;padding-left: 7px">
                                                                                ...
                                                                                <div class="isAnonymous">
                                                                                    ...
                                                                                    <a id="loginPageRedirect" class="adbHeaderLink pr-0" href="{{ auth()->check() ? route('user-profile') : route('login') }}" style="padding-left: 0;margin-top: 5px">
                                                                            ...
                                                                            <div style="padding-top: 5px;">
                                                                                <div class="profile-dropdown-content" style="color: #3E4152;margin-bottom: 5px;">
                                                                                    <a class="adbHeaderLink" href="{{ auth()->check() ? route('user-profile') : route('login') }}">My Profile</a></div>
                                                                                <div class="profile-dropdown-content" style="color: #3E4152;margin-bottom: 5px">
                                                                                    <a class="adbHeaderLink" href="{{ auth()->check() ? route('order_list') : route('login') }}">My Orders</a></div>
                                                                            ...
                                                                            <div class="loggedUser">
                                                                                <div style="padding-top: 5px;border-top: 1px solid #f0f0f0;">
                                                                                    <div class="profile-dropdown-content" style="color: #3E4152;margin-bottom: 5px">
                                                                                        <a class="adbLogout pr-0" id="logoutFromProfile" href="{{route('admin.logout')}}" data-uri="/customer/logout">Logout</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
...
div#mobileMenu {
    ...
    /* Mobile Header (visible on max 768px) */
    .mobile-header {
      display: none;
    }
.col.l4.mobile {
  ...
  <div class="mobile-header">
    <div class="mobile-header-left">
     <button class="hamburger" id="menuToggleBtn" onclick="toggleMenu()">☰</button>
    ...
    <div class="mobile-header-icons">
      ...
      <!--</div>-->
      <div class="icon-wrapper">
        <span><a href="{{route('product.cart')}}">🛒</a></span>

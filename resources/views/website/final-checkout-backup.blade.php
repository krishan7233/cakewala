      ...
      <h2>Order Details</h2>
        ...
        <form action="{{ route('payment.initiate') }}" method="POST" id="paymentForm">
                ...
                <!-- <div class="form-group">
                    ...
                    <option value="thank_you" selected>Thank You</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ake-message-input" nname="order_messages"  rows="4" maxlength="250" placeholder="Write your message here..."></textarea>
                        <div style="text-align: right; font-size: 12px;"><span id="charCount">0</span>/250</div>
                    </div>

                    <!-- Sender Information -->
                    <div class="form-group">
                        <label for="sender_name">Sender Name *</label>
                        <input type="text" id="sender_name" name="sender_name" value="KRISHAN MOHAN PANDEY" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="sender_phone" name="sender_phone" value="7233958662" pattern="[6-9]{1}[0-9]{9}" required>
                        </div>
                    </div>
